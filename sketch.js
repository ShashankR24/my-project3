...
function draw() {
  ...
  fireBall.x = spiderMan.x
  fireBall.y = spiderMan.y

  }
  if(electroGroup.isTouching(fireBall)){
    ...
    if (keyDown("space") && spiderMan.y > 284) {
...
function story() {
  ...
  fill("silver")
  stroke("black")
  text("THE SPIDERMAN ADVENTURE",15, 200)
  textSize(10);
  fill("yellow")
  stroke("orange")
  text("Made by Shashank", 50, 100)
...
function control() {
  ...
  text("You need to escape the obstacles and enemies and collect the coins to earn points. ", 20, 300);
